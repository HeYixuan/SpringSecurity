...
public class SpringSecurityService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new User(username, systemUser.getPassword(), systemUser.isEnabled(),
                systemUser.isAccountNonExpired(), systemUser.isCredentialsNonExpired(),
                systemUser.isAccountNonLocked(), authorities);
    }
}
